...
\begin{center}
    \begin{circuitikz}
        ...
        -| ++ (0.5,-1) node[ground]{};
    \end{circuitikz}
\caption{RF signal block diagram}
\label{fig:rfblock}
\end{center}
\end{figure}
...
\end{circuitikz}
\caption{DC power distribution block diagram}
\label{fig:dcblock}
\end{center}
\end{figure}
